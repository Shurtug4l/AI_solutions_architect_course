...
The mechanics (Art 40): the Commission requests standards from the European standardization organizations; **CEN-CENELEC JTC 21** drafts them, reusing international work from **ISO/IEC JTC 1/SC 42** where it fits (the management-system standard 42001, risk guidance 23894, the terminology backbone 22989, the data-quality and robustness families); the Commission cites the finished standards in the Official Journal; and from that moment, compliance with the cited standard grants a **presumption of conformity** with the requirements it covers. A second, narrower presumption sits beside it in Art 42: high-risk systems trained and tested on data reflecting the specific geographic and behavioral setting of use are presumed to meet the Art 10(4) data requirement, and systems certified under an EU cybersecurity scheme are presumed to meet the Art 15 cybersecurity bar. Worth keeping the two apart, Art 40 is the standards route, Art 42 the context-and-certification route, and swapping their article numbers is a common slip.
