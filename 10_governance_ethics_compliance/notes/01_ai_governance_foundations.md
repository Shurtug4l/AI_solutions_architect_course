...
- **Legislators and regulators**: the EU with the AI Act and the enforcement stack around it (Commission's AI Office for GPAI and coordination, national market surveillance authorities, data protection authorities where GDPR overlaps). They set binding constraints and hold the sanction lever.
