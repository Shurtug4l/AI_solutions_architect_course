...
5. **Register and revisit.** Findings land in a risk register with owner, mitigation, status, and review date, and the register plugs into the Art 9 loop: post-market monitoring feeds new entries, incidents reopen old ones, and the cadence is written down.
